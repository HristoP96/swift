...
public class Task5_VehicleMonitor {
    ...
    public static void main(String[] args) {
        ...
        //реших да направя задачата по различен начин(зашото много си прилича с предната) , единственото нещо,което съм взел от от решенията е String licenseNo = String.format("%04d", j);,защото не можах да се сетя за алтернатива.
